...
from llm_attacks.minimal_gcg.opt_utils import token_gradients, sample_control, get_logits, target_loss, self_loss, get_token_gradient
...
def get_prefix_grad(input_idsA, input_idsB, input_sliceA, input_sliceB, target_sliceA, target_sliceB, modelA, deviceA, modelB, deviceB):
    ...
    coordinate_gradA, coordinate_gradB, loss = get_token_gradient(modelA, input_idsA, input_sliceA, target_sliceA, deviceA,
